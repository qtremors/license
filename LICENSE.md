...
| **Internal Business Use** | ❌ **NO** | **Requires written permission.** |
...
> **Note:** `{{GITHUB_REPO}}` is a placeholder. Replace it with the actual repository name when applying this license to a project.
...
If you wish to use this Software for commercial purposes (e.g., in a product, revenue-generating service, or **internal business tool**), you **MUST** obtain a Commercial License.
